...
//~ Note: 'rop' is supposed to be already initialised (see sglv_scalar.h)
//~ Note: k3 is the key to decompose
void build_glvScalar(SGLVScalar *rop, mpz_t k3, mpz_t aa, mpz_t bb, mpz_t Na){
